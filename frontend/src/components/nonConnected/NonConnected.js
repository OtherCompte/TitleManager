...
export default function NonConnected({ conUser }) {
    ...
    return (
        <div className="container mt-5">
            ...
            <div className="card mb-3 mt-5 p-3 mx-auto" style={{ maxWidth: "700px"}}>
                <div className="card-body">
                    <h2 className="card-title text-center">À quoi sert l'outil ?</h2>
                    <p className="card-text">L'outil vous permet de récupérer, à partir de votre clé API Youtube et un mot clé, une liste de titres Youtube récupérés depuis la <span style={{fontWeight: "800"}}>Youtube DATA v3 API</span></p>
